...
const features = [
  {
    ...
    description:
      "Browse through thousands of internships and entry-level positions.",
    color: "purple",
  },
  {
    icon: Users,
...
export default function Home() {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setCurrentCarouselSlide(
        (prev) => (prev + 1) % (carouselImages.length - 3)
      );
    }, 3000); // Change slide every 3 seconds
  ...
  return (
    <div
      className={`min-h-screen ${isDarkMode ? "bg-[#0A0B14]" : "bg-gray-100"}`}
    >
      {/* Navbar */}
      <nav
        className={`${
          ...
          <div className="space-x-6 flex items-center">
            ...
            <button
              ...
              className={`p-2 rounded-full ${
                isDarkMode ? "bg-[#12131E]" : "bg-gray-200"
              }`}
            >
              {isDarkMode ? (
                <Sun
      ...
      <section className="relative h-[600px] flex items-center px-6 md:px-12 lg:px-20 pt-24 bg-[#0A0B14]">
        ...
        <div className="relative z-20 max-w-2xl ml-auto">
          ...
          <p className={`text-2xl text-gray-300 mb-8`}>
            Discover internships, courses, and part-time jobs tailored for
            students.
          </p>
      ...
      <section
        className={`py-20 ${isDarkMode ? "bg-[#12131E]" : "bg-gray-200"}`}
      >
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            >
              Our platform provides everything you need to kickstart your career
              while managing your studies.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 relative">
            {features.map((feature, index) => (
              <div
                ...
                className={`${
                  isDarkMode ? "bg-[#1A1B26]" : "bg-white"
                } p-8 rounded-lg hover:shadow-lg hover:-translate-y-2 transition-all duration-300 relative`}
              >
                <div
                  className={`absolute -top-12 -right-12 p-6 rounded-full bg-${feature.color}-500/20`}
                >
                  <feature.icon
                    className={`h-16 w-16 text-${feature.color}-500`}
                  />
                </div>
                <h3
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            >
              Watch our quick tutorial to learn how to make the most of our
              platform.
            </p>
          </div>
      ...
      <section
        className={`py-20 ${isDarkMode ? "bg-[#0A0B14]" : "bg-gray-100"}`}
      >
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            <h2
            ...
            >
              We provide the best opportunities and resources to help you
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              >
                Only the best and verified opportunities.
              </p>
            </div>
            <div className="text-center">
              <Star
              ...
              <p
                className={`${isDarkMode ? "text-gray-400" : "text-gray-600"}`}
              >
                Connect with top companies and startups.
              </p>
            </div>
            <div className="text-center">
              <Smile
      ...
      >
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            >
              Stay updated with the latest internships, courses, and job
              opportunities.
            </p>
          </div>
